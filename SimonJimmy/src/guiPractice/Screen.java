...
//		}
	...
	public void remove(Visible v){
		 ...
		 * }
		 * 
		 * for this reason, the following doesnt even work
		 * because remove changes the size
		 * for(integer i:list) {
		 * 	if(i > 5)list.remove(1);
		 * }
		 * finally, if u remove using an indez, it returns the 
		 * removed object, so you can do this
